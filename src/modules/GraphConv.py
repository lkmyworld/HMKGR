...
class GraphConv(nn.Module):
    ...
    def __init__(self, embed_dim, n_hops, n_users,
                 n_items, n_relations, device, dropout_rate):
        ...
        for i in range(n_hops):
            self.aggregator_layers.append(Aggregator(n_users=n_users, n_items=n_items).to(self.device))
